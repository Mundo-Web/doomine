...
@section('content')
  ...
  <main>
    <div id="container" class="w-[93%] mx-auto ">
      ...
      <section id="banner" class="grid z-30  bg-cover bg-bottom"
        style="background-image: url('{{ asset('images/landing/banner1.png') }}');">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-7 mt-12 xl:mt-24 w-full">
          ...
          <div class="col-span-2 grid">
            <div class="cards content-center justify-self-start space-y-12 xl:space-y-32">
              <div class="card">
                <h4 class="font-boldItalicDisplay text-3xl w-52">Versatilidad</h4>
          ...
          <div class="col-span-2 bg-[#f5f5f5] pb-10">
            ...
            <form action="" class=" mx-auto w-10/12 space-y-8" id="formContactosLanding">
              ...
              <div>
                ...
                <div class="">
                  <input name="full_name" type="text"
                    class="rounded-xl w-full py-4 px-4 ring-0 focus:ring-0 border-0 border-transparent focus:border-0"
              ...
              <div>
                ...
                <div class="">
                  <input name="phone" id="telefono" type="text"
                    class="rounded-xl w-full py-4 px-4 ring-0 focus:ring-0 border-0 border-transparent focus:border-0"
                    placeholder="+51">
                </div>
      ...
      <section id="banner" class="grid  bg-cover mt-16 xl:mt-32"
        style="background-image: url('{{ asset('images/landing/banner4.png') }}');">
