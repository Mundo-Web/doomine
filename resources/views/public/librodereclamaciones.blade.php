...
@section('content')
  <section class="w-11/12 mx-auto gap-5 grid grid-cols-1 grid-rows-1  lg:gap-10 pt-60">
    ...
    <form class="flex flex-col gap-5" id="formLibroReclamo">
      <div class=" my-16 grid grid-cols-1  lg:grid-cols-4 gap-5 justify-center items-center">
        ...
        <div class="flex flex-row col-span-4 gap-2 ">
          ...
          <label for="termsandconditions" class="font-medium text-sm text-[#6C7275]">Estoy de acuerdo con los <a
              class="font-bold" href="{{ route('terms_condition') }}">terminos y
              condiciones</a></label>
        ...
        <div class="flex flex-row col-span-2 gap-2 ">
          <button type="submit" value="Enviar a libro de reclamaciones" id="btnAjax"
            class="col-span-4 text-white bg-[#74A68D] py-3 rounded-2xl cursor-pointer border-2 font-semibold text-[16px] text-center border-none w-full md:w-auto px-10 inline-block">Enviar
